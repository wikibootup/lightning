...
OAuth2RequestOptions.getThingplusOptions = function(method, resource_url, token) {
...
*/
OAuth2RequestOptions.getOptions = function(method, domain, resource_url, token) {
  const options = {
    method: method,
...
module.exports = OAuth2RequestOptions;
